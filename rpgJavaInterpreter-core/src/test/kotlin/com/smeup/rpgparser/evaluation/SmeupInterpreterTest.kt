...
open class SmeupInterpreterTest : AbstractTest() {
    ...
    */
    ...
    @Test
    fun executeT10_A20_P21_31() {
        val expected = listOf<String>(
            "Res(-1, -2, -3, -5, -7, -11) Fact2(1, 2, 3, 5, 7, 11)",
            "Res(7, 7, 7, 7, 7, 7) Fact2(1, 2, 3, 4, 5, 6)",
            "Res(7, 7, 7, 7, 7, 7) Fact2(6, 5, 4, 3, 2, 1) Fact1(1, 2, 3, 4, 5, 6)",
            "Res(5, 3, 1, -1, -3, -5) Fact2(1, 2, 3, 4, 5, 6)",
            "Res(-5, -3, -1, 1, 3, 5) Fact2(6, 5, 4, 3, 2, 1) Fact1(1, 2, 3, 4, 5, 6)",
            "Res(6, 10, 12, 15, 14, 11) Fact2(1, 2, 3, 5, 7, 11)",
            "Res(6, 10, 12, 12, 10, 6) Fact2(6, 5, 4, 3, 2, 1) Fact1(1, 2, 3, 4, 5, 6)",
            "Res(6, 2, 1, 0, 0, 0) Fact2(1, 2, 3, 5, 7, 11)",
            "Res(0, 0, 0, 1, 2, 6) Fact2(6, 5, 4, 3, 2, 1) Fact1(1, 2, 3, 4, 5, 6)",
            "Res(0,00000, 0,00000, 0,00000, 0,00000, 0,00000, 0,00000) Fact2(1,00000, 2,00000, 3,00000, 5,00000, 7,00000, 11,00000)",
            "Res(0,16666, 0,40000, 0,75000, 1,33333, 2,50000, 6,00000) Fact2(6,00000, 5,00000, 4,00000, 3,00000, 2,00000, 1,00000) Fact1(1,00000, 2,00000, 3,00000, 4,00000, 5,00000, 6,00000)"
        )
        assertEquals(expected, "smeup/T10_A20_P21_31".outputOf())
    }
}